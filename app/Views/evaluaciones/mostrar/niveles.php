...
<div class="espacioDos"></div>
          ...
          <div class="espacioUno"></div>
              <div class="card">
                ...
                ?>
                <div class="niveles" style="margin-left:20px;margin-right:20px;padding-top:10px;padding-bottom:15px;">
                  </h4><a href="<?php echo site_url("Evaluaciones/lecciones/$id_evaluacion/$fila->id");?>"><?php echo $fila->nombre?></a></h4>
                <br>
