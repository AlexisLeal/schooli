  ...
  <div id="general">
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="card">
          <div class="card-body">
            <form action="<?php echo site_url('Horarios/editar'); ?>" method="post">
              ...
              <div class="row">
                <div class="col">
                  hora de inicio
                  <input type="time" name="horaInicio" id="horaInicio" class="form-control form-control-sm" require="" value="<?php echo $horaInicio ?>">

                </div>
                <div class="col">
                  Hora Fin
                  <input type="time" name="horaFin" id="horaFin" class="form-control form-control-sm" require="" value="<?php echo $horaFin ?>">
              ...
              <div class="espacioUno"></div>
              <input type="hidden" name="idHO" id="idHO" value="<?php echo $idHO; ?>">
