  ...
  <div id="general">
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <table>
        <tr>
          <td><a href="<?php echo site_url('/Teachers/index'); ?>" ><i class="fa fa-arrow-circle-o-left fa-2x" aria-hidden="true"></i></a></td>
          <td><a href="<?php echo site_url('/Teachers/index'); ?>" >Atras</a></td>
        </tr>
        </table>  
        <div class="espacioUno"></div>
