        ...
        <div class="row">
          ...
          <?php include(APPPATH.'/Views/include/notificacion.php');?>
              ...
              Listado de recursos
                ...
                <thead>
                <tr>
                <th><p class="font-weight-bold text-center">ID</p></th>
                <th><p class="font-weight-bold text-center">Nombre:</p></th>
                <th><p class="font-weight-bold text-center">Extension:</p></th>
                <th><p class="font-weight-bold text-center">Tipo de archivo.</p></th>
                <th><p class="font-weight-bold text-center">Descripcion:</p></th>
                </tr>
                </thead>
                <?php
