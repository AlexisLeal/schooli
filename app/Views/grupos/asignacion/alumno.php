          ...
          <div class="espacioUno"></div>
            <h4>Grupos</h4>
              <div class="card">
                ...
                <a href="<?php echo site_url('/Grupos/agregargrupo'); ?>"> Crear un grupo </a> / <a href="<?php echo site_url("/Grupos/vergrupo/$id_grupo")?>"> Panel del grupo </a> / <a href="<?php echo site_url('Grupos/index')?>"> Panel de Recursos </a> <br/>
                <hr class="linea"/>
                ...
                <button type="submit" name="submitAL" class="btn btn-primary btn-sm">Asignar</button>
            </form>
