      ...
      <div id="general">
        <div class="row">
          ...
          <h4>Eliminar recursos.</h4>
              ...
              <form action="<?php echo site_url('Asignacion/eliminarRecurso');?>" method="post">
                <?php foreach(getGrupoRecursosEliminar($id_grupo) as $fila){?> 
               ...
               <?php }?> 
                ...
                <div class="text-center">
                <input type="submit" value="Eliminar" name="submitRC" class="btn btn-primary btn-sm">
                </div>
              </form>
