...
class Comprobacion extends BaseController{
    ...
    public function check(){
        ...
        $query = "SELECT * FROM usuarios WHERE usuario='".$credenciales['credencial']."' and password='".$credenciales['inputPassword']."' and estado=1 and id_tipo_usuario = '".$credenciales['tipo_usuario']."'AND delated = 0";
