...
class Control_grupos_calificaciones_evaluaciones_model extends Model
{
    ...
    protected $allowedFields = ['id_alumno','id_grupo','id_evaluacion','id_curso','id_nivel','session','id_ciclo',
    'calificacion','calificaciontotal','fecha_creacion','fecha_ultimo_cambio'];
